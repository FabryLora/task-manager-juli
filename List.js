...
class List {
  ...
  addList(){
    ...
    const content = `
      ...
      <h1 class="title ${this.domName}">
        ...
        <span class="listmenu">
          <button id="removelist-button" class="removelist ${this.domName}">x</button>
        </span>
        </h1>
  ...
  bottomMenu(){
    ...
    let content = `
      <div class="newitem">
        <input placeholder="Enter title..." class="input-${this.domName}">
  ...
  optionsMenu(listElement){
    ...
    let content = `
      <button id="options-button" class="dropbtn options-${this.domName}">Options</button>
